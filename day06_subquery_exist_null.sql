...
/*----------------------------------------------------------------
SORU 4 : MAyis ayinda satilip Nisan ayinda satilmayan urun ismini ve
satin alan kisiyi listeleyen bir QUERY yaziniz.
----------------------------------------------------------------*/
select urun_isim,musteri_isim
from mayis_satislar
...
from insanciklar
order by ssn desc;
-- Soru 5: Insanciklar tablosundaki tum kayitlari Soyisimler ters sirali,
select *
from insanciklar
