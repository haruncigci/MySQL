...
----------------------------------------------------------------*/
-- 1.Adim : Personel sayisi 15000 den fazla olan sirketleri listele
select sirket 
from sirketler
where personel_sayisi>15000;

-- 2.Adim :Ford ve Toyotada calisan personeli listele
select isim , sirket
from personel
where sirket in('Ford','Toyota');

-- 3. Adim: Personel sayisi 15000 den cok olan sirketleri ve burada calisan personeli listele
select isim , sirket
from personel
...
-- Honda sirketinin personel sayisini 16000 olarak güncelleyiniz
