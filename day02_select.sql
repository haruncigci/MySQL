...
-- Q2 : Derecesi 80'den kücük olan ogrencilerin isimlerini getirin.
...
select *
from personel 
where isim Like 'ayse%';  -- Bu sekilde olunca Ayse ile baslayanlari getirir

select *
from personel 
where isim Like '%ayse%'; -- > bu sekilde olursa ismin icinde Ayse olanlarin hepsini getrir.
